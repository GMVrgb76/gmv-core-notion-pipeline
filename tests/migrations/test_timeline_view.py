...
def test_migration_three_requires_an_explicit_target_until_live_cutover(
    tmp_path: Path,
) -> None:
    database = tmp_path / "explicit-cutover.db"

    assert migrations.migrate(database) == migrations.OID_SEQUENCE_VERSION
